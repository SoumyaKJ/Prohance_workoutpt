	 ...
	 
	{
		 ...
		 List<WebElement> rows = WebUI.findWebElements(findTestObject('Worktype Definition Screen/Page_ProHance Work Output/worktypes_rows'),10)
			...
			for (int j = 1; j <=rows.size(); j++)
						 ...
						 
								 {
										 ...
										 if (header.size() == 6)
											...
											worktypes.add(worktype)
											 ...
											 obj4.addProperty("xpath", ConditionType.EQUALS,"//table[@id='CommonDataTableId']/tbody/tr[${j}]/td[1]/a[1]/i")
											...
											TestObject obj5 = new TestObject()
											 ...
											 obj5.addProperty("xpath", ConditionType.EQUALS, "//table[@id='userAttributeTableTable']/tbody/tr/td//table[@id='dataTable']//tr//td[1]")
											 
											def defaultoption= WebUI.getText(obj5).trim()
											
											//defaultoptions.add(defaultoption)
											
											
											TestObject obj6 = new TestObject()
						 
											 obj6.addProperty("xpath", ConditionType.EQUALS, "//*[@id='userAttrEstdHrValue_-1']")
											 
											  def ehtvalue = WebUI.getAttribute(obj6, "value")?.trim()
											
											   ehtvalues.add(ehtvalue)
											 
											 
											 
											WebUI.click(findTestObject('Object Repository/Worktype Definition Screen/Page_ProHance Work Output/back button'))
										 
											values.add( "$worktype-> $defaultoption-> $ehtvalue")
				 ...
				 /*
				 values.each { worktypeName, dataList ->
					 
						 Set<String> uniqueValues =
								 new LinkedHashSet<>(dataList)
					 
						 println("Work Type Name : " + worktypeName)
					 
						 println("EHT Values     : " + uniqueValues)
					 
						 println("--------------------------------")
					 }*/
				 
				def wtandehtvalues=worktypes+ehtvalues
