...
String targetMonthYear = 'May 2026'
...
// Select day
def day=WebUI.click(findTestObject('Object Repository/Worktype Definition Screen/Page_ProHance Work Output/day15th', [('day') : targetDay]))

def currentday=WebUI.getAttribute(findTestObject('Object Repository/Worktype Definition Screen/Page_ProHance Work Output/date verification'),'value')
//verifying selected date in calander
...
/*
String actualDate = WebUI.getAttribute(findTestObject('Object Repository/Worktype Definition Screen/Page_ProHance Work Output/date verification'), 
   'value')

println(actualDate)
*/
//Verifying view history model icon present and clickable
