...
if (numberofpage > 3) {
    for (int i = 1; i <= numberofpage; i++) {
        ...
        pageBtn.addProperty('xpath', ConditionType.EQUALS, "//table[@id='CommonDataTableId']/tbody/tr${i}")
...
WebUI.click(findTestObject('Category/Page_ProHance Work Output/li_Work Type Category'))

WebUI.setText(findTestObject('Category/Page_ProHance Work Output/serach text area'), 'Data')
