...
WebUI.verifyElementText(findTestObject('Object Repository/Wo_seetings/Page_ProHance Work Output/data approval setting label2')
,'Allow users to upload Quality, ACT, THT Data when no Volumes data is available')

def label = WebUI.findWebElements(findTestObject('Object Repository/Wo_seetings/Page_ProHance Work Output/data approval_check box option label'),10)
...
WebUI.verifyElementText(findTestObject('Object Repository/Wo_seetings/Page_ProHance Work Output/data import setting label1'),
	'Allow users to upload WO data when no Work Time data has been captured from')


def type = WebUI.getAttribute(findTestObject('Object Repository/Wo_seetings/Page_ProHance Work Output/data approval_check box verification'),'type')
