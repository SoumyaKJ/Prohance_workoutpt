...
def generaltab = WebUI.getText(findTestObject('Object Repository/Wo_settings/Page_ProHance Work Output/general tab'))
...
WebUI.verifyElementText(findTestObject('Object Repository/Wo_settings/Page_ProHance Work Output/td_Define Work Type Estimated Hours (Handling Ti'), 
    'Define Work Type Estimated Hours (Handling Time) on')

WebUI.verifyElementText(findTestObject('Object Repository/Wo_settings/Page_ProHance Work Output/td_Data Collection - Label (ProHance Mate)_'), 
...
def value = WebUI.getAttribute(findTestObject('Object Repository/Wo_settings/Page_ProHance Work Output/data label'), 'class')

def Actualvalue = 'textbox'

assert value == Actualvalue

def numberofchar = WebUI.getText(findTestObject('Object Repository/Wo_settings/Page_ProHance Work Output/datacollection label_character count'))
...
def value1 = WebUI.getAttribute(findTestObject('Object Repository/Wo_settings/Page_ProHance Work Output/category label'), 
    'class')
...
def numberofchar1 = WebUI.getText(findTestObject('Object Repository/Wo_settings/Page_ProHance Work Output/category label char'))

def actualchar1 = '#25'

assert numberofchar1 == actualchar1

def AHT_label = WebUI.getText(findTestObject('Object Repository/Wo_settings/Page_ProHance Work Output/Enable auto computation of AHT_label'))

def AHT_actuallabel = "Enable auto computation of "

assert AHT_label.startsWith(AHT_actuallabel)
...
def text = WebUI.getText(findTestObject('Wo_settings/Page_ProHance Work Output/Select categories for Actual Productive Hours'))

def actaulatext = 'Select categories for \'Actual Productive Hours\''

assert text == actaulatext

WebUI.click(findTestObject('Object Repository/Wo_settings/Page_ProHance Work Output/AHT_dropdown'))

WebUI.click(findTestObject('Object Repository/Wo_settings/Page_ProHance Work Output/actual productive hours_option'))

def productoptions = WebUI.findWebElements(findTestObject('Object Repository/Wo_settings/Page_ProHance Work Output/product_options'), 
    10)

def type = WebUI.getAttribute(findTestObject('Wo_settings/Page_ProHance Work Output/product_options'), 'type')
...
def inputs = WebUI.findWebElements(
    findTestObject('Object Repository/Wo_settings/Page_ProHance Work Output/product_options'),
    10
)
