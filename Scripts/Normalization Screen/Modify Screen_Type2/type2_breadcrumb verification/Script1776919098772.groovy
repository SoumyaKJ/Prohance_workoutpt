...
WebUI.click(findTestObject('Normalization Screen/Page_ProHance Work Output/Page_ProHance Work Output/type2_modify_icon'))

WebUI.waitForPageLoad(10)

//Breadcrum veriification

def breadcrumb=WebUI.getText(findTestObject('Object Repository/Normalization Screen/Page_ProHance Work Output/breadcrumb'))

print breadcrumb

def Actualtext="Administration Work Output Work Output Normalization Work Output Normalization Details [Type 2] "
...
// Assert that breadcrumb matches expected text
assert breadcrumb==Actualtext
