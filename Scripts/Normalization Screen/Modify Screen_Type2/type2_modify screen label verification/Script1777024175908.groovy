...
String actualText = WebUI.getText(findTestObject('Object Repository/Normalization Screen/Page_ProHance Work Output/type2_Divisor_text'))

actualText = actualText.replaceAll("\\s+", " ").trim()

String expectedText = "Expected Productive Hours"
...
// Switch to the Work Output frame with a 10 second timeout
WebUI.switchToFrame(findTestObject('Normalization Screen/Page_ProHance Work Output/frame'), 10)
...
WebUI.verifyElementText(findTestObject('Object Repository/Normalization Screen/Page_ProHance Work Output/Page_ProHance Work Output/td_Metric Name'), 'Metric Name*')

// Verify the Output Multiplier Value label text
WebUI.verifyElementText(findTestObject('Object Repository/Normalization Screen/Page_ProHance Work Output/Page_ProHance Work Output/td_Output Multiplier Value'), 'Output Multiplier Value*')

// Verify the Is Active label text
WebUI.verifyElementText(findTestObject('Object Repository/Normalization Screen/Page_ProHance Work Output/Page_ProHance Work Output/td_Is Active'), 'Is Active*')

// Verify the Units Label text
WebUI.verifyElementText(findTestObject('Object Repository/Normalization Screen/Page_ProHance Work Output/Page_ProHance Work Output/span_Units Label'), 'Units Label')

// Click the Divisor cell
WebUI.click(findTestObject('Object Repository/Normalization Screen/Page_ProHance Work Output/Page_ProHance Work Output/td_Divisor'))

// Verify the Yes label text
WebUI.verifyElementText(findTestObject('Object Repository/Normalization Screen/Page_ProHance Work Output/Page_ProHance Work Output/span_Yes'), ' Yes')

// Verify the No label text
WebUI.verifyElementText(findTestObject('Object Repository/Normalization Screen/Page_ProHance Work Output/Page_ProHance Work Output/label_No'), ' No')

// Switch to the Work Output frame with a 10 second timeout
WebUI.switchToFrame(findTestObject('Normalization Screen/Page_ProHance Work Output/frame'), 10)

// Get the divisor text
String actualText = WebUI.getText(findTestObject('Object Repository/Normalization Screen/Page_ProHance Work Output/type2_Divisor_text'))
