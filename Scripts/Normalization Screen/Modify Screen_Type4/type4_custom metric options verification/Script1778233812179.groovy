...
def custommetric = WebUI.findWebElements(findTestObject('Object Repository/Normalization Screen/Page_ProHance Work Output/custom metric options'), 
    10)

def custommetricname = custommetric.collect({ 
        it.getText().trim()
    })
