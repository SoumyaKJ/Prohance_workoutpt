...
WebUI.click(findTestObject('Normalization Screen/Page_ProHance Work Output/select_1st radio button'))

String actualText = WebUI.getText(findTestObject('Object Repository/Normalization Screen/Page_ProHance Work Output/type3 Activities on system and or Away from system Hours'))

actualText = actualText.replaceAll('\\s+', ' ').trim()

String expectedText = 'Activities on system and/or Away from system Hours Allow all activities on system and/or away from system Allow only the selected activities on system and/or away from system Do not allow the selected activities on system and/or away from system Note: Activities tagged to \'Personal Time\' will not be considered.'
